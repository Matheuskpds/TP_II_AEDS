        ...
        if(i>0){//se a quantidade gerada for maior que 0, preenche-se a matriz
            while(i>0){
                ...
                if(coluna != linha && matriz[linha][coluna]!=1){
                    ...
                    //printf("Colocando 1 na coluna [%d]\n", coluna);
                    matriz[linha][coluna]=1;
                    i--;
                }
            }
...
void verifica_solucao(int cont, int matriz[cont][cont]){
    ...
    while ( num[r] == 0 ){
        for ( i = 0; i < n; i++ ) {
            ...
            //printf("\ncont2: %d\n", valida_arranjo(cont, matriz, str, cont2));
...
int main() {
    ...
    printf("%d\n", cont);
    int matriz2[20][20];
    preenche_matriz_aleatoria(20, matriz2);
    print_matriz(20, matriz2);
    //verifica_solucao(cont,matriz);*/
    ...
    //com a matriz preenchida
    //gera um valor aleatorio de 1's
    //gero uma coluna aleatoria pra inserir cada um
